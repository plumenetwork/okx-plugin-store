...
if [ "$REMOTE_VER" != "$LOCAL_VER" ]; then
  ...
  npx skills add okx/plugin-store --skill compound-v2-plugin --yes --global 2>/dev/null || true
...
BIN_TMP=$(mktemp -d)
RELEASE_BASE="https://github.com/okx/plugin-store/releases/download/plugins/compound-v2-plugin@0.1.1"
