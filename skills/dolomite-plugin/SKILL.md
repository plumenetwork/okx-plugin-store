...
if [ "$DO_CHECK" = true ]; then
  REMOTE_VER=$(curl -sf --max-time 3 "https://raw.githubusercontent.com/mig-pre/plugin-store/main/skills/dolomite-plugin/plugin.yaml" | grep '^version' | head -1 | tr -d '"' | awk '{print $2}')
